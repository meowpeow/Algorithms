 ...
 * Instead, binary search can find element in a sorted array in less amount of cycles, by using MIDDLE of the list.
 * 1.      So to get it to work you need to assign to variables BEGIN of the list and END of it.
 * 2.      The program now will find a middle of that list, and compare that MID variable to element we are searching for.
